...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helikopter_B.ElevationCounttorad), 0, 0, 22 }
  ,
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&helikopter_P.ElevationCounttorad_Gain), 0, 0, 32 },
